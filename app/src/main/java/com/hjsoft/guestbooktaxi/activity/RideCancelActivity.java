...
import com.hjsoft.guestbooktaxi.fragments.RideCancelFragment;
import com.hjsoft.guestbooktaxi.model.NavigationData;

/**
 * Created by hjsoft on 30/1/17.
 */
public class RideCancelActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Fragment fragment=new RideCancelFragment();
        FragmentManager fragmentManager = getSupportFragmentManager();
        fragmentManager.beginTransaction().add(R.id.content_frame, fragment,"ride_stop").commit();
