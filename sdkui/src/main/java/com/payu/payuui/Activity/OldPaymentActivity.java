...
public class OldPaymentActivity  extends AppCompatActivity implements MagicRetryFragment.ActivityCallback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
           ...
           // Toast.makeText(OldPaymentActivity.this,"In Bank",Toast.LENGTH_LONG).show();
            ...
            mWebView.addJavascriptInterface(new Object() {
                ...
                public void onSuccess(final String result) {
                   // Toast.makeText(OldPaymentActivity.this,"success"+result,Toast.LENGTH_LONG).show();
...
//                }
                ...
                public void onFailure(final String result) {
                    ...
                    //Toast.makeText(OldPaymentActivity.this,"failure"+result,Toast.LENGTH_LONG).show();
