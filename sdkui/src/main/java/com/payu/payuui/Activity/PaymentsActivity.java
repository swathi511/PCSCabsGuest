        ...
        if (savedInstanceState == null) {
            ...
            if (payuConfig != null) {
                ...
                PayUCustomBrowserCallback payUCustomBrowserCallback = new PayUCustomBrowserCallback() {
                   ...
                   // Toast.makeText(PaymentsActivity.this,"payment failure",Toast.LENGTH_LONG).show();
                    ...
                    public void onPaymentTerminate() {
                       // Toast.makeText(PaymentsActivity.this,"payment terminate",Toast.LENGTH_LONG).show();
                    ...
                    public void onPaymentSuccess(String payuResponse, String merchantResponse) {
                       ...
                       // Toast.makeText(PaymentsActivity.this,merchantResponse+":"+payuResponse+":",Toast.LENGTH_LONG).show();
                    ...
                    public void onCBErrorReceived(int code, String errormsg) {
                        //Toast.makeText(PaymentsActivity.this,"cb error ",Toast.LENGTH_LONG).show();
                    }

                    @Override
                    public void setCBProperties(WebView webview, Bank payUCustomBrowser) {
                    //  Toast.makeText(PaymentsActivity.this,"cb properties",Toast.LENGTH_LONG).show();
                    ...
                    public void onBackApprove() {
                     ...
                     // Toast.makeText(PaymentsActivity.this,"back approve",Toast.LENGTH_LONG).show();
                    ...
                    public void onBackDismiss() {
                      ...
                      // Toast.makeText(PaymentsActivity.this,"back dismiss",Toast.LENGTH_LONG).show();
                    ...
                    public void onBackButton(AlertDialog.Builder alertDialogBuilder) {
                     ...
                     //  Toast.makeText(PaymentsActivity.this,"back button",Toast.LENGTH_LONG).show();
                   ...
                   // Toast.makeText(PaymentsActivity.this,"magic retry",Toast.LENGTH_LONG).show();
