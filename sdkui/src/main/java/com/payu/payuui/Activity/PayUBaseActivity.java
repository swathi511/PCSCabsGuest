...
//                 close the progress bar
    ...
    private void setupViewPagerAdapter(final PayuResponse payuResponse, PayuResponse valueAddedResponse) {
        ...
        System.out.println("************************");
        System.out.println(payuResponse.isResponseAvailable()+":"+payuResponse.getResponseStatus().getCode());
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
       ...
       // Toast.makeText(PayUBaseActivity.this,"In PayUBAse",Toast.LENGTH_LONG).show();
